...
const UpdateArticleCategoryPage = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const response = await fetch(`${process.env.NEXT_PUBLIC_API_BASE_ROUTE}article-categories?id=${slug}`); // API call
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await axios.patch(
        `/api/article-categories?id=${slug}`, // Your route
        apiData,
        {
          headers: {
