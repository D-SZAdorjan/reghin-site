...
const articleCategoryList = [
    {
        name: {
            de: "Vorschlag für eine Reise",
            en: "Trip Suggestion",
            fr: "Suggestion de voyage",
            hu: "Utazási javaslat",
            ro: "Sugestie de călătorie"
        },
        priority: BigInt("1"),
    },
    {
...
async function main() {
    try {
        ...
        console.log("Data in ArticleCategory table are deleted!");
        await prisma.MonumentCategory.deleteMany();
        console.log("Data in MonumentCategory table are deleted!");
        await prisma.Article.deleteMany();
        console.log("Data in Article table are deleted!");
        await prisma.Monument.deleteMany();
        console.log("Data in Monument table are deleted!");
        await prisma.NotablePersonality.deleteMany();
        console.log("Data in NotablePersonalities table are deleted!");
        ...
        console.log("ArticleCategories are created!");

        await prisma.MonumentCategory.createMany(
            { data: monumentCategoryList }
        );
        console.log("MonumentCategories are created!");
        ...
        console.log("Monuments are created!");

        await prisma.NotablePersonality.createMany(
            { data: personDataList }
        );
        console.log("NotablePersonalities are created!");
